...
| --- | --- | --- | --- |
| auth (login / register / logout / session / verification / password reset) | ✅ | ✅ | partial (login / register) |
| watchlist | ✅ | ✅ | partial (list) |
| market (quote / history / recommendations / refresh) | ✅ | ✅ | none yet |
| research (analyze / latest / history / quote) | ✅ | ✅ | none yet |
| workflow (tasks / progress / trace) | ✅ | ✅ | none yet |
| intelligence (timeline / metrics / risk signals / document-index search) | ✅ | ✅ | none yet |
| companies (search / count / list / analysis-status) | ✅ | ✅ | none yet |
| evaluation (rag cases / run) | ✅ | ✅ (TODO) | none yet |
| ingestion (demo / async) | ✅ | ✅ (TODO) | none yet |

The remaining IIFE migrations are split across the RFC 002
follow-ups and the larger RFC 005 module split.
